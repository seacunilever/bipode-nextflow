...
| `meta_mapper`   | file path      | Path to the metadata mapper YAML file that maps your column names to Bipode's expected names. Only needed for raw data inputs when your column names differ from Bipode's requirements.                        | No       | -       |
...
| `batch_key`                | string  | Field(s) to use as batch key in the Bipode model                                                                                                                                                                   | No       | "Exposure plate ID" or "Exposure plate ID,date" |
