# `seacunilever/bipode-nextflow`: Contributing Guidelines

Hi there!
Many thanks for taking an interest in improving seacunilever/bipode-nextflow.

We try to manage the required tasks for seacunilever/bipode-nextflow using GitHub issues, you probably came to this page when creating one.
...
To make the `seacunilever/bipode-nextflow` code and processing logic more understandable for new contributors and to ensure quality, we semi-standardise the way the code and other contributions are written.
...
- Open the repo in [Codespaces](https://github.com/seacunilever/bipode-nextflow/codespaces)
- Tools installed
  - nf-core
  - Nextflow
